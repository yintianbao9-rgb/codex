...
- **CLI**：lt when supported, improving tool discovery while preserving compatibility with older models and providers. ( #29486 ) macOS authentication clients can honor system proxy, PAC, and WPAD settings when respect_system_proxy is enabled. ( #26709 ) Plugins can prov
...
- **IDE**：pilot copilot Jun.30 Improvement GitHub code coverage merge protection for pull requests application security Jun.30 Improvement Releases: Sidebar navigation and per-asset download counts collaboration tools Jun.30 Release Copilot Agent is now available in Jet

### Anthropic News
- 类型：industry
- URL：https://www.anthropic.com/news
- **agent**：all access to Fable 5 and Mythos 5. Product Jun 30, 2026 Introducing Claude Sonnet 5 Sonnet 5 delivers frontier performance across coding, agents, and professional work at scale. Announcements Jun 30, 2026 Claude Science, an AI workbench for scientists, is now
- **agents**：all access to Fable 5 and Mythos 5. Product Jun 30, 2026 Introducing Claude Sonnet 5 Sonnet 5 delivers frontier performance across coding, agents, and professional work at scale. Announcements Jun 30, 2026 Claude Science, an AI workbench for scientists, is now
...
- **IDE**：aude Science is a customizable app that integrates the tools and packages researchers most often use, produces auditable artifacts, and provides flexible access to computing resources. Product Jun 23, 2026 Introducing Claude Tag Claude Tag is a new way for tea
...
- **agent**：Pay Play Search Smart Home TensorFlow TV Wallet Wear OS Workspace Technology Select all AI Cloud Mobile Web JUNE 30, 2026 / AI Driving the Agent Quality Flywheel from Your Coding Agent Building AI agents often leaves developers uncertain if prompt tweaks to fi
- **agents**：orkspace Technology Select all AI Cloud Mobile Web JUNE 30, 2026 / AI Driving the Agent Quality Flywheel from Your Coding Agent Building AI agents often leaves developers uncertain if prompt tweaks to fix single errors will accidentally cause widespread regres
- **browser**：being transformed through Chrome DevTools for agents, the HTML-in-Canvas API, and the proposal of WebMCP, an open web standard that enables browser-based AI agents to execute complex tasks. Previous Next Filter Clear filters Content Type Select all Announcemen
