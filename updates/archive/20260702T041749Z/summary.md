...
- **agent**：plication security Jun.30 Improvement Releases: Sidebar navigation and per-asset download counts collaboration tools Jun.30 Release Copilot Agent is now available in JetBrains AI Assistant copilot Jun.30 Release Open source license compliance is in public prev
