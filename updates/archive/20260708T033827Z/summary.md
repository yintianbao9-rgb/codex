...
- **ChatGPT**：erra, and Luna models, with first-class support for max reasoning effort. ( #30285 , #30467 ) MCP tools now use tool search by default, and ChatGPT-hosted MCP servers can explicitly use session authentication. ( #29486 , #29733 ) App-server clients can inspect
...
- **CLI**：ls now use tool search by default, and ChatGPT-hosted MCP servers can explicitly use session authentication. ( #29486 , #29733 ) App-server clients can inspect environments, list descendant threads, and fork history through a specific turn. ( #30291 , #29591 ,
...
- **agent**：kit The Making of Claude Code Features Jul 6, 2026 The inside story of how Claude Code went from an internal CLI to Anthropic&#x27;s coding agent, told by researchers, engineers and early users who built it. Announcements Jun 30, 2026 Redeploying Fable 5 Fable
...
- **CLI**：rt Media assets Download press kit The Making of Claude Code Features Jul 6, 2026 The inside story of how Claude Code went from an internal CLI to Anthropic&#x27;s coding agent, told by researchers, engineers and early users who built it. Announcements Jun 30,
- **IDE**：@anthropic.com Non-media inquiries How to get support Media assets Download press kit The Making of Claude Code Features Jul 6, 2026 The inside story of how Claude Code went from an internal CLI to Anthropic&#x27;s coding agent, told by researchers, engineers 
