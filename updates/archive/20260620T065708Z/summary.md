...
- **CLI**：scovery also adds a created-by-me marketplace and auth-specific curated catalogs. ( #27870 , #27884 , #27893 , #28203 , #28383 ) App-server clients can list immediate child threads, correlate external-agent imports with detailed results, and read or redeem rat
...
- **agent**：ub’s own AI coding tool, GitHub Copilot, check out GitHub&#8217;s official documentation . Featured How we built an internal data analytics agent Qubot, our internal Copilot-powered analytics agent, allows any GitHub employee to ask questions about our data in
...
- **IDE**：ot CLI Attend GitHub Universe AI & ML AI & ML Learn about artificial intelligence and machine learning across the GitHub ecosystem and the wider industry. Generative AI Learn how to build with generative AI. GitHub Copilot Change how you work with GitHub Copil
...
- **agent**：Opus 4.6 (fast) copilot Jun.18 Release MAI-Code-1-Flash available on more Copilot surfaces copilot Jun.18 Improvement Copilot code review: AGENTS.md support and UI improvements copilot Jun.18 Release Detecting Duplicate Issues &#8211; Public Preview and issue 
...
- **IDE**：Release Extend GitHub with agent apps copilot Jun.02 Improvement Introducing Copilot CLI and agentic capabilities enhancements in JetBrains IDEs copilot Jun.02 Release Gemini models in Copilot CLI, cloud agent, and the Copilot app copilot Jun.02 Release Gain i

### Anthropic News
- 类型：industry
- URL：https://www.anthropic.com/news
- **agent**：ountries. Product May 28, 2026 Introducing Claude Opus 4.8 An upgrade to our Opus class of models, with stronger performance across coding, agentic tasks, and professional work, and the consistency to handle long-running work. Announcements May 25, 2026 Anthro
- **agents**：e Claude for Slack Claude for Microsoft 365 Skills Download app Pricing Log in to Claude Models Mythos Fable Opus Sonnet Haiku Solutions AI agents Code modernization Coding Customer support Education Enterprise Financial services Government Healthcare Legal Li
- **Chrome**：anding Project Glasswing See more Products Claude Claude Code Claude Code Enterprise Claude Cowork Claude Design Claude Security Claude for Chrome Claude for Slack Claude for Microsoft 365 Skills Download app Pricing Log in to Claude Models Mythos Fable Opus S
- **CLI**：nsistency to handle long-running work. Announcements May 25, 2026 Anthropic co-founder Chris Olah&#x27;s remarks on Pope Leo XIV&#x27;s encyclical "Magnifica humanitas" The full text of Chris Olah&#x27;s remarks on the Pope&#x27;s encyclical on AI. News Search
- **IDE**：oundry Console login Resources Blog Claude partner network Community Connectors Courses Customer stories Engineering at Anthropic Events Inside Claude Code Inside Claude Cowork Inside Claude Enterprise Inside Claude Security Plugins Powered by Claude Service p

### Google AI Developers Blog
- 类型：industry
- URL：https://developers.googleblog.com/en/search/?query=Gemini
- **agent**：rFlow TV Wallet Wear OS Workspace Technology Select all AI Cloud Mobile Web JUNE 18, 2026 / AI How A2A is Building a World of Collaborative Agents Celebrating the first anniversary of the Agent-to-Agent (A2A) protocol, this blog post highlights how the framewo
- **agents**：rFlow TV Wallet Wear OS Workspace Technology Select all AI Cloud Mobile Web JUNE 18, 2026 / AI How A2A is Building a World of Collaborative Agents Celebrating the first anniversary of the Agent-to-Agent (A2A) protocol, this blog post highlights how the framewo
